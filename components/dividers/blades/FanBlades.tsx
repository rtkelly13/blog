...
/**
 * **Fan** — the deck answer: the dividers sit as an almost-closed stack until
 ...
 */
export default function FanBlades({
  dividers,
  initialIndex = 0,
}: DividerSetProps) {
  ...
  const centre = (dividers.length - 1) / 2;
  ...
  return (
    <div className="flex h-full w-full flex-col gap-3">
          ...
          return (
            <button
              ...
              style={{
                ...
                zIndex: lifted ? dividers.length + 1 : index,
              }}
      ...
      >
        {current ? <DividerBody divider={current} compact /> : null}
      </div>
    </div>
  );
}
