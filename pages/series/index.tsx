              ...
              <article>
                <div className="space-y-4">
                  <div>
                    ...
                    <h2 className="text-2xl font-display font-bold leading-8 tracking-tight uppercase border-l-4 border-accent-primary pl-4">
                      <Link
                  ...
                  {series.posts.length > 0 && (
                    <div className="pl-4">
                      <h3 className="font-display text-xs uppercase text-accent-secondary tracking-wider mb-2">
                        Posts in Series:
                      </h3>
                      <ol className="space-y-1">
                        {series.posts.map((post) => (
                          ...
                          >
                            <span className="font-mono text-xs text-accent-primary font-bold mt-0.5">
                              {String(post.order + 1).padStart(2, '0')}.
                            </span>
                            <Link
                              href={`/blog/${post.slug}`}
                              className="font-mono text-sm text-gray-300 hover:text-accent-primary transition-colors"
                            >
                              {post.title}
                            </Link>
                          </li>
                  ...
                  <div className="font-mono text-base leading-6 pl-4">
                    <Link
                      href={`/series/${series.slug}`}
                      className="text-accent-primary hover:text-accent-tertiary border-b-2 border-accent-primary hover:border-accent-tertiary font-bold"
