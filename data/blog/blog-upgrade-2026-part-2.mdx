...
tldr: "Incremental beat big-bang: foundation first (npm→pnpm, ESLint+Prettier→Biome), then React 19, Next.js 16, Tailwind 4 and Turbopack, then Playwright and CI. AI handled the mechanical migrations, and the upgrade surfaced long-standing RSS, sitemap and tag-feed bugs along the way."
images: []
layout: PostLayout
authors: ["default"]
series:
