---
title: "Discovering AI-Assisted Development"
kind: article
status: developing
created: "2026-01-15"
updated: "2026-07-12"
tags: ["ai", "opencode", "gemini", "developer-tools", "blog", "productivity"]
target: "future data/blog/blog-upgrade-2026-part-1.mdx — part of the Blog Revival 2026 series"
...
> **Draft TL;DR (AI suggestion):** Three years of dependency drift stopped being intimidating once I tried OpenCode and Gemini CLI. AI excelled at mechanical migration work and struggled with judgement calls; the workflow that clicked was phase-by-phase prompts with non-negotiable human review.

## Resurrection checklist

- [ ] The discovery story is the whole value — retell OpenCode/Gemini CLI first contact from memory; the AI draft invented the narrative arc.
- [ ] Verify the ✅/❌ "what AI was good/bad at" lists against what actually happened.
- [ ] Salvage: the phase-by-phase-with-review workflow and the week-1 lessons.
- [ ] Experiment: re-enact the "just fix the build" first session as a `<Terminal>` script.
...
![Blog before upgrade - AWS Batch Cookbook article](/static/images/blog-before-upgrade.png)
_The blog as it looked before the upgrade - a minimal academic aesthetic with the AWS Batch Cookbook article_
...
**Continue to Part 2:** [Upgrading Dependencies and Tools](/ideas/blog-revival-part-2) — The technical details of migrating React 17→19, Tailwind 3→4, and Webpack→Turbopack with AI assistance.

**Or jump to Part 3:** [Design System Implementation](/ideas/blog-revival-part-3) — Deep dive into the retro-brutalist terminal design, color systems, and lessons learned.
