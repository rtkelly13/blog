---
title: "Upgrading Dependencies and Tools"
kind: article
status: developing
created: "2026-01-15"
updated: "2026-07-12"
tags: [ "nextjs", "react", "tailwind", "turbopack", "webpack", "pnpm", "biome", "playwright", "migration", "ai" ]
target: "future data/blog/blog-upgrade-2026-part-2.mdx — part of the Blog Revival 2026 series"
...
> **Draft TL;DR (AI suggestion):** Incremental beat big-bang: foundation first (npm→pnpm, ESLint+Prettier→Biome), then React 19, Next.js 16, Tailwind 4 and Turbopack, then Playwright and CI. AI handled the mechanical migrations, and the upgrade surfaced long-standing RSS, sitemap and tag-feed bugs along the way.

## Resurrection checklist

- [ ] Verify every version/migration claim against git history (npm→pnpm, ESLint+Prettier→Biome, React 19, Next 16, Tailwind 4, Turbopack; the RSS/sitemap/tag-feed bug fixes).
- [ ] Refresh stale numbers — the repo has moved on since the draft was written.
- [ ] Salvage: the incremental-over-big-bang strategy, the what-broke catalogue, the quality-infrastructure phase (Playwright + CI).
- [ ] Experiments: `<Terminal>` for the upgrade command sequences; `<IdeaDeck>` for the four phases.

---

## Original AI draft (reference material)

_This is Part 2 of a three-part series. [Read Part 1](/ideas/blog-revival-part-1) for the AI discovery story, or skip to [Part 3](/ideas/blog-revival-part-3) for the design system deep dive._

---

After discovering that OpenCode could actually help tackle my 3-year-old blog's dependency drift ([Part 1](/ideas/blog-revival-part-1)), I needed a systematic approach to upgrade everything without breaking the site.
...
**Next:** [Part 3: Design System Implementation](/ideas/blog-revival-part-3) - The retro-brutalist terminal aesthetic breakdown.

**Previous:** [Part 1: Discovering AI-Assisted Development](/ideas/blog-revival-part-1)
