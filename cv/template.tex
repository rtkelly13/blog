...
\begin{twenty}
    ...
    \twentyitem
        ...
        {}
        {
            ...
            As part of my role as Principal, I had to think about the long term technology strategy of how we migrate our application stack off the .NET Framework. Took a two tier approach, working on slow harmonising and extracting common components into a supported version. Then work with our front-end engineer to initiate a design system using Storybook to build scalable solution for efficiently porting pages to a REST API + React site from a MVC 5 application.
            
            The AI Code Agent development recently was something everyone had to adapt to, I spent the time looking through the tooling requirements and how to adopt it seamlessly in our environment. Finding the ways not just to embrace it but to actively make our experience with software engineering better. I like to thing better engineering outcomes leads to better Agentic engineering outcomes. \par 
